...
export const buttonVariants = cva(
  "active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-color focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offest-2 disabled:opacity-50 dark:focus:ring-slate-400 disabled:pointer-envents-none dark:focus:ring-offset-slate-900",
  {
    variants: {
      variant: {
        default:
